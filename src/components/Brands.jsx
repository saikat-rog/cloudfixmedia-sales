...
export default function Brands() {
  ...
  return (
    <div className="w-full py-10 bg-black text-white text-center flex flex-col items-center">
      ...
      <div className="overflow-hidden">
        <Marquee
          ...
          speed={300} // Reduced speed for smoother scrolling
          gradientColor={[0, 0, 0]} // Proper RGB format for black gradient
        >
          <img src={One} alt="Brand 1" className="h-16 mx-10 rounded-lg" />
          <img src={Two} alt="Brand 2" className="h-16 mx-10" />
          <img src={Three} alt="Brand 3" className="h-16 mx-10" />
          <img src={Four} alt="Brand 4" className="h-16 mx-10" />
          <img src={Eight} alt="Brand 5" className="h-16 mx-10" />
          <img src={Five} alt="Brand 5" className="h-16 mx-10" />
          <img src={Six} alt="Brand 5" className="h-16 mx-10" />
          <img src={Seven} alt="Brand 5" className="h-16 mx-10" />
        </Marquee>
      </div>
    </div>
  );
